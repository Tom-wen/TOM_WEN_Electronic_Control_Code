 ...
 * @return 映射后的输出值
 */
float linear_map_clamped(float input, float in_min, float in_max, float out_min, float out_max)
{
    float result;
    ...
    result = (input - in_min) / (in_max - in_min) * (out_max - out_min) + out_min;
