...
void CAN_cmd_friction(int16_t left_friction, int16_t rigit_friction)
{
  ...
  gimbal_tx_message.MessageMarker=0;
	HAL_StatusTypeDef status = HAL_FDCAN_AddMessageToTxFifoQ(&hfdcan3,&gimbal_tx_message, gimbal_can_send_data);
}
...
void CAN_cmd_gimbal(int16_t yaw, int16_t pitch)
{
  ...
  gimbal_tx_message.TxEventFifoControl=FDCAN_NO_TX_EVENTS;
  gimbal_tx_message.MessageMarker=0;
  HAL_StatusTypeDef status_1 = HAL_FDCAN_AddMessageToTxFifoQ(&hfdcan3,&gimbal_tx_message, gimbal_can_send_data);
  ...
  HAL_StatusTypeDef status_2 = HAL_FDCAN_AddMessageToTxFifoQ(&hfdcan3,&gimbal_tx_message, gimbal_can_send_data);
}
