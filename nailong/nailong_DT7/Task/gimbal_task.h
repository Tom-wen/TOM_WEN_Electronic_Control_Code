...
/** Yaw轴鼠标灵敏度 */
#define YAW_MOUSE_SEN 0.00009f

/** Pitch轴鼠标灵敏度 */
#define PITCH_MOUSE_SEN 0.000055f
...
#define PITCH_GYRO_MAX_OUT   1000.0f
#define PITCH_GYRO_MAX_IOUT 30000.0f

/* Pitch前馈电流参数 */
#define PITCH_CURRENT_FEEDFORWARD -4000.0f

/* ******************************************************************
 * 宏定义 - Yaw轴PID参数
 ****************************************************************** */
/* Yaw角度环控制参数 */
#define YAW_ABSOLUTE_ANGLE_KP   -20.0f
#define YAW_ABSOLUTE_ANGLE_KI   0.0f
#define YAW_ABSOLUTE_ANGLE_KD   0.01f
#define YAW_ABSOLUTE_ANGLE_MAX_OUT  5.0f
#define YAW_ABSOLUTE_ANGLE_MAX_IOUT 1.0f

/* Yaw角速度环控制参数 */
#define YAW_GYRO_KP   6000.0f
#define YAW_GYRO_KI   0.0f
#define YAW_GYRO_KD   0.1f
#define YAW_GYRO_MAX_OUT   30000.0f
