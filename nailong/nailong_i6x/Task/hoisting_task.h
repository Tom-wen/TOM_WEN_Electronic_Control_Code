...
#define HOISTING_MOTOR_GYRO_KP_1 4
#define HOISTING_MOTOR_GYRO_KI_1 0
#define HOISTING_MOTOR_GYRO_KD_1 0
#define HOISTING_MOTOR_GYRO_MAX_OUT_1 5
#define HOISTING_MOTOR_GYRO_MAX_IOUT_1 5
...
#define HOISTING_MOTOR_GYRO_MAX_OUT_2 12.0
...
#define HOISTING_MOTOR_GYRO_KP_3 4
#define HOISTING_MOTOR_GYRO_KI_3 0
#define HOISTING_MOTOR_GYRO_KD_3 0
#define HOISTING_MOTOR_GYRO_MAX_OUT_3 5
...
#define HOISTING_MOTOR_GYRO_KP_4 4
#define HOISTING_MOTOR_GYRO_KI_4 0
#define HOISTING_MOTOR_GYRO_KD_4 0
#define HOISTING_MOTOR_GYRO_MAX_OUT_4 5
#define HOISTING_MOTOR_GYRO_MAX_IOUT_4 100

//遥控器
#define FORWARD_CHANNEL 4
#define BACK_CHANNEL 5
#define RC_TO_HOISTING_DEADBAND 10

#define forward_RC_SEN 0.000002f
#define back_RC_SEN 0.000002f
