...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, Power_5V_Pin|ACC_CS_Pin|GYRO_CS_Pin|USERLED_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI1_CS1_GPIO_Port, SPI1_CS1_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI1_CS2_Pin|SPI1_CS3_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : Power_5V_Pin USERLED_Pin */
  GPIO_InitStruct.Pin = Power_5V_Pin|USERLED_Pin;
  ...
  /*Configure GPIO pins : SPI1_CS2_Pin SPI1_CS3_Pin */
  GPIO_InitStruct.Pin = SPI1_CS2_Pin|SPI1_CS3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  /*Configure GPIO pin : SPI1_INT3_Pin */
  GPIO_InitStruct.Pin = SPI1_INT3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(SPI1_INT3_GPIO_Port, &GPIO_InitStruct);
