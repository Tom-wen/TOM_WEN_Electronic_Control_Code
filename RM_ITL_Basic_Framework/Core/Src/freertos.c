...
/* Definitions for app_arm_lift */
osThreadId_t app_arm_liftHandle;
uint32_t app_arm_liftBuffer[ 512 ];
osStaticThreadDef_t app_arm_liftControlBlock;
const osThreadAttr_t app_arm_lift_attributes = {
  .name = "app_arm_lift",
  .cb_mem = &app_arm_liftControlBlock,
  .cb_size = sizeof(app_arm_liftControlBlock),
  .stack_mem = &app_arm_liftBuffer[0],
  .stack_size = sizeof(app_arm_liftBuffer),
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for app_hoisting */
osThreadId_t app_hoistingHandle;
uint32_t app_hoisitingBuffer[ 512 ];
osStaticThreadDef_t app_hoisitingControlBlock;
const osThreadAttr_t app_hoisting_attributes = {
  .name = "app_hoisting",
  .cb_mem = &app_hoisitingControlBlock,
  .cb_size = sizeof(app_hoisitingControlBlock),
  .stack_mem = &app_hoisitingBuffer[0],
  .stack_size = sizeof(app_hoisitingBuffer),
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for app_lerobot */
osThreadId_t app_lerobotHandle;
uint32_t app_lerobotBuffer[ 512 ];
osStaticThreadDef_t app_lerobotControlBlock;
const osThreadAttr_t app_lerobot_attributes = {
  .name = "app_lerobot",
  .cb_mem = &app_lerobotControlBlock,
  .cb_size = sizeof(app_lerobotControlBlock),
  .stack_mem = &app_lerobotBuffer[0],
  .stack_size = sizeof(app_lerobotBuffer),
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for app_ui */
osThreadId_t app_uiHandle;
uint32_t app_uiBuffer[ 256 ];
osStaticThreadDef_t app_uiControlBlock;
const osThreadAttr_t app_ui_attributes = {
  .name = "app_ui",
  .cb_mem = &app_uiControlBlock,
  .cb_size = sizeof(app_uiControlBlock),
  .stack_mem = &app_uiBuffer[0],
  .stack_size = sizeof(app_uiBuffer),
  .priority = (osPriority_t) osPriorityNormal,
};
...
void MX_FREERTOS_Init(void) {
  ...
  /* creation of app_arm_lift */
  app_arm_liftHandle = osThreadNew(arm_lift_task, NULL, &app_arm_lift_attributes);

  /* creation of app_hoisting */
  app_hoistingHandle = osThreadNew(hoisting_task, NULL, &app_hoisting_attributes);

  /* creation of app_lerobot */
  app_lerobotHandle = osThreadNew(lerobot_task, NULL, &app_lerobot_attributes);

  /* creation of app_ui */
  app_uiHandle = osThreadNew(ui_task, NULL, &app_ui_attributes);
