...
extern volatile uint32_t sbus_rx_total;
extern volatile uint32_t sbus_rx_valid;

// 定义回调函数指针类型
typedef void (*usart_rx_callback_t)(uint8_t *buf, uint16_t size);

extern uint8_t usart1_rx_buf[256];
extern uint8_t usart7_rx_buf[256];
extern uint8_t sbus_buf[25];
extern uint8_t usart8_rx_buf[256];
extern uint8_t usart9_rx_buf[256];
