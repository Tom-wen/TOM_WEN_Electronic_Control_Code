#ifndef __ROBOTIC_SWING_GIMBAL_H__
#define __ROBOTIC_SWING_GIMBAL_H__
...
//yaw轴灵敏度
#define yaw_sensitivity        0.0004f //0.0004f
//pitch轴灵敏度
...
#define pitch_up_max       -27.0f       //pitch向上最大值
#define pitch_down_max       27.8f      //pitch向下最大值度
#define GRAVITY_COMPENSATION  -000.0f    //重力补偿值

#define AUTOAIM_REPLAY_TASK_DT_S  0.002f
#define AUTOAIM_YAW_FF_CURRENT_LIMIT      14000.0f
#define AUTOAIM_YAW_ACC_FF_GAIN           0.20f
