...
{   
    ...
    //底盘3508单环PID初始化
    PID_Init(&motors1[0].motor_data->pid[single_loop], 23.0f, 1.0f, 0.1f, 10.0f, 10000.0f, 0.0f);
    ...
    PID_Init(&motors1[1].motor_data->pid[single_loop], 23.0f, 1.0f, 0.1f, 10.0f, 10000.0f, 0.0f);
    ...
    PID_Init(&motors1[2].motor_data->pid[single_loop], 23.0f, 1.0f, 0.1f, 10.0f, 10000.0f, 0.0f);
    PID_Init(&motors1[2].motor_data->pid[cascade_inner], 20.0f, 0.0f, 0.0f, 10.0f, 15000.0f, 0.0f);
    PID_Init(&motors1[2].motor_data->pid[cascade_outer], 1.0f, 0.0f, 0.0f, 10.0f, 1000.0f, 0.0f);
    
    PID_Init(&motors1[3].motor_data->pid[single_loop], 23.0f, 1.0f, 0.1f, 10.0f, 10000.0f, 0.0f);
    PID_Init(&motors1[3].motor_data->pid[cascade_inner], 200.0f, 0.0f, 0.0f, 10.0f, 15000.0f, 0.0f);
    ...
    PID_Init(&motors2[0].motor_data->pid[cascade_inner], 200.0f, 0.0f, 0.0f, 10.0f, 15000.0f, 0.0f);
    PID_Init(&motors2[0].motor_data->pid[cascade_outer], 2.0f, 0.0f, 0.0f, 10.0f, 1000.0f, 0.0f);

    PID_Init(&motors2[1].motor_data->pid[single_loop], 15.0f, 0.0f, 0.0f, 10.0f, 10000.0f, 0.0f);
    PID_Init(&motors2[1].motor_data->pid[cascade_inner], 200.0f, 0.0f, 0.0f, 10.0f, 15000.0f, 0.0f);
    PID_Init(&motors2[1].motor_data->pid[cascade_outer], 2.0f, 0.0f, 0.0f, 10.0f, 1000.0f, 0.0f);
    
    PID_Init(&motors2[2].motor_data->pid[single_loop], 15.0f, 0.0f, 0.0f, 10.0f, 10000.0f, 0.0f);
    PID_Init(&motors2[2].motor_data->pid[cascade_inner], 200.0f, 0.0f, 0.0f, 10.0f, 15000.0f, 0.0f);
    PID_Init(&motors2[2].motor_data->pid[cascade_outer], 2.0f, 0.0f, 0.0f, 10.0f, 1000.0f, 0.0f);
    
    PID_Init(&motors2[3].motor_data->pid[single_loop], 15.0f, 0.0f, 0.0f, 10.0f, 10000.0f, 0.0f);
    PID_Init(&motors2[3].motor_data->pid[cascade_inner], 200.0f, 0.0f, 0.0f, 10.0f, 15000.0f, 0.0f);
    PID_Init(&motors2[3].motor_data->pid[cascade_outer], 2.0f, 0.0f, 0.0f, 10.0f, 1000.0f, 0.0f);
...
void RemoteControlChassis(Chassis_Ctrl_Cmd_s *Chassis_Cmd) 
{
    ...
    switch(Chassis_Cmd->chassis_mode) 
    {
        case CHASSIS_FOLLOW_GIMBAL_YAW:                         //跟随云台
            ...
            Chassis_Cmd->w = -(float)rc_ctrl.rc.ch[4]*0.01;
            break;
...
void AGV_Cal(Chassis_Ctrl_Cmd_s *Chassis_Cmd)
{
    ...
    Chassis_Cmd->wheel3508_rpm[2] = sqrt(pow((Chassis_Cmd->vy + vw * cos45), 2) + pow((Chassis_Cmd->vx - vw * sin45), 2))*-1;
    Chassis_Cmd->wheel3508_rpm[3] = sqrt(pow((Chassis_Cmd->vy + vw * cos45), 2) + pow((Chassis_Cmd->vx + vw * sin45), 2))*-1;
