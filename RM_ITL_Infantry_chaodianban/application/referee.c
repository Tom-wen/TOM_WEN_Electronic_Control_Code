...
void get_chassis_power_and_buffer(float *current,float *volt,float *power, float *buffer)
{
		*current=power_heat_data_t.chassis_current;
	  *volt=power_heat_data_t.chassis_volt;
...
void get_shoot_heat0_limit_and_heat0_17(uint16_t *heat0_limit, uint16_t *heat0)
{
...
void get_shoot_heat1_limit_and_heat1_17(uint16_t *heat1_limit, uint16_t *heat1)
{
...
void get_shoot_heat0_limit_and_heat0_42(uint16_t *heat0_limit, uint16_t *heat0)
{
		*heat0_limit = robot_state.shooter_id1_42mm_cooling_limit;
    *heat0 = power_heat_data_t.shooter_heat_42;
}
